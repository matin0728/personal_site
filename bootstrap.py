...
app = webapp2.WSGIApplication([
  webapp2.Route(r'/', handler=home.HomeHandler, name='home'),
  ...
  webapp2.Route(r'/question/<question_id:\d+>', handler=question.QuestionHandler, name="question"),
  ...
  webapp2.Route(r'/question/<question_id:\d+>/add_answer', handler=question.QuestionAddAnswerHandler, name="question.add_answer"),
  ...
  webapp2.Route(r'/question/add', handler=question.QuestionAddHandler, name="question.add"),
  webapp2.Route(r'/signup', handler=home.SignupHandler, name='signup'),
...
], debug = shared.SITE_CONFIG['is_debug'], config=shared.SITE_CONFIG)
